...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        //toggle custom daterange
        this.showCustomDateRange = options.showCustomDateRange;

        var noCustomDateRangeTemplate = '<div class="daterangepicker dropdown-menu">' +
                '<div class="ranges">' +
        ...
        DRPTemplate = options.showCustomDateRange ? DRPTemplate : noCustomDateRangeTemplate;
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.ranges === 'object') {
                ...
                //HACKERY: removes the custom dateRange selection
                if(this.showCustomDateRange) list += '<li>' + this.locale.customRangeLabel + '</li>';
                list += '</ul>';
